...
async function processPreUpdateActorHooks(changed, { pack }) {
    ...
    if (actor.prototypeToken.actorLink !== true && !(foundry.utils.getProperty(actor || {}, "flags.item-piles.data.enabled") || foundry.utils.getProperty(foundry.utils.flattenObject(changed), "flags.item-piles.data.enabled"))) {
